...
declare module 'virtual:svg-component' {
  const MySvgIcon: import("vue").DefineComponent<{
      name: {
          type: import("vue").PropType<"icon-icon-addUser" | "icon-icon-barCode" | "icon-icon-card2" | "icon-logo" | "icon-common-icon-add" | "icon-common-icon-add3" | "icon-common-icon-addUser" | "icon-common-icon-addUsers" | "icon-common-icon-addx" | "icon-common-icon-apple" | "icon-common-icon-banner" | "icon-common-logo">;
          default: string;
          required: true;
      };
